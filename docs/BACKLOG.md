...
> **Build status:** stories 1–8, 10–12 are implemented and covered by tests. Stories 9 and 13
> are the responsive/visual verification passes — their code is built to `docs/DESIGN.md`, but
> checking them off requires a real-browser visual review (resize at 390/768/1440, D3 self-review),
> which belongs to QA/CLOSEOUT.

## Epic 1 — Core spectrum experience

- [x] **1. Live spectrum chart redraws on every network add/remove (WOW MOMENT)**
...
- [x] **2. Add-network form captures name, band, and channel with validation**
...
- [x] **3. Remove a network from the running list**
...
- [x] **4. Least-congested-channel recommendation with a visible marker**
...
- [x] **5. Design polish — apply DESIGN.md's blueprint direction to the core add/chart flow**
...
- [x] **6. Independent 2.4GHz/5GHz band toggle drives its own recommendation**
...
- [x] **7. Adjacent-channel interference curve matches expected overlap behavior**
...
- [x] **8. Duplicate and invalid input handling**
...
- [x] **10. Persist entered networks across page reloads**
...
- [x] **11. Shareable link encodes the current network list**
